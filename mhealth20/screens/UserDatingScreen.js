...
const usersData = [
  ...
  },
  {
    ...
    likeBalance: 50,
    premiumMember: true,
    profileImage: require("../assets/femaledoc1.png"),
    latitude: 28.02228,
    longitude: -82.7729,
    profiles: {
      dating: {
...
const UserDatingScreen = () => {
  ...
  const filteredUsers = usersData.filter(user => {
    const distance = calculateDistance(
      primaryUserData.latitude,
      primaryUserData.longitude,
      user.latitude,
      user.longitude
    );
    ...
    <View style={styles.container}>
      ...
      >
        ...
        >
          ...
          <Callout>
            <Text>{primaryUserData.firstName}</Text>
          </Callout>
        </Marker>
      ...
      <View style={styles.pickerContainer}>
        ...
        >
           <Picker.Item label="100 feet" value={100} />
           <Picker.Item label="200 feet" value={200} />
           <Picker.Item label="300 feet" value={300} />
           <Picker.Item label="400 feet" value={400} />
          <Picker.Item label="500 feet" value={500} />
          <Picker.Item label="600 feet" value={600} />
          <Picker.Item label="1000 feet" value={1000} />
          <Picker.Item label="1500 feet" value={1500} />
          <Picker.Item label="2000 feet" value={2000} />
        </Picker>
      </View>
    </View>
  );
